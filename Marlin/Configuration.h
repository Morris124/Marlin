...
#define STRING_CONFIG_H_AUTHOR "(Maurice, CR-10S)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Maurices CR-10S"
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN P1_28 // Creality CR-10S stock sensor
